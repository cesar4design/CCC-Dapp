    ...
    return (
      <>
        <style jsx global>
          {`
      body {
          background: url(https://i.ibb.co/6472FjJ/Frame-1-4.png); 
       }
   `}
        </style>
        <Card  background={"transparent"} border={"none"} outline={"none"} boxShadow={"none"}>

          <CardBody className={styles.general} >
            <Center>
              <Box
                rounded={'lg'}
                mt={-12}
            ...
            <Stack    spacing='0'>
              <h1 className={styles.h1}>DEVIL FRIENDS</h1>
              <p className={styles.p}>Just bunch of devils</p>
              {loading ? (
                <div>
                  <Divider my="10px" />
               ...
               <Box background={"#000000"} color={"white"} borderRadius={"12px"} marginTop={"8px"}  p={3} >
                    <VStack textAlign={"center"} >
                      <Text fontSize={"12px"}>Available NFTs: {666 - Number(candyMachine?.itemsRedeemed)}/{Number(666)}</Text>
                    </VStack>
                  </Box>
        ...
        <Modal  isOpen={isShowNftOpen} onClose={onShowNftClose}>
          <ModalOverlay />
          <ModalContent fontFamily={"pixel"} background={"#272931"} color={"white"}>
